...
from agents.sac_agent_cleanrl import SACAgent, ArgsSac
    ...
    for ego_type in ego_types:
        ...
        for run in range(0, runs):
            ...
            if algo == "dqn":
                ...
                args = tyro.cli(ArgsSac)
                model_adv = SACAgent(env_ego, args)
            ...
            if ego_type == "baseline":
                ...
                model_ego = DQN.load(
                    f"models\\model_ego_dqn_01_05_25_defensive.zip",
