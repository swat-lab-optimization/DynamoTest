    ...
    for ego_type in ego_types:
        ...
        for run in range(runs):
            ...
            if ego_type == "baseline":
                ...
                # adv_file = "out\\run_20250627-184624_22388\\checkpoint-best.tar"
                ego_file = (
                    "out\\run_20251018-142520_21916_ego_retrain\\checkpoint-best.tar"
                )
                a_c_1 = load_agent_config(model_json_file)
                model_ego = agent_factory(env_ego, a_c_1)
                ...
                model_json_file = "models\\dqn.json"
                ego_file = (
                    "out\\run_20251018-191048_15876_ego_aggressive\\checkpoint-best.tar"
                )
                a_c_1 = load_agent_config(model_json_file)
                model_ego = agent_factory(env_ego, a_c_1)
                ...
                model_ego = DQN.load(
                    "models\\model_ego_dqn_01_05_25_defensive.zip",
                    env=env_ego,  # "models\\model_ego_dqn_26_05_25_aggressive_5.zip" models\model_ego_dqn_01_05_25_defensive.zip
                )
